  ...
  return (
    <div className="container-fluid p-0">
      ...
      <div id="productos" className="productos-encabezado">
            <h2 className='p-4 m-0 text-center text-uppercase h3'>Productos</h2>
      </div>
      {prods.map(producto => (
      ...
      <div className="productos-calidad">
        ...
        <div className='d-md-flex text-center justify-content-center p-5'>
          <div>
            <img src="../img/organico.png" className='p-3 iconos-calidad' alt="Organico" />
              <p className='text-white text-uppercase'>100% <br />Organico</p>
          </div>
          <div>
            <img src="../img/sin-tacc.png"  className='p-3 iconos-calidad'alt="Sin Tacc" />
            <p className='text-white text-uppercase'>Sin <br />Tacc</p>

          </div> 
          <div> 
            <img src="../img/sin-conservantes.png"  className='p-3 iconos-calidad'alt="Sin Conservantes" />
      ...
      <footer className='productos-calidad'>
        ...
        <div className='p-3 row g-0 d-flex justify-content-evenly' style={{backgroundColor:"#0E0E0E"}}>
          ...
          <img src="../img/LogoHumaya100x100.png" height="150px" alt="" />
          </div>
